export const CHARS = {
  ...
  ember: { nm:'燹 · EMBER', ic:'▲', col:'#ff7a3c', rgb:'255,122,60', hp:5, spd:348, burn:true,
    weapon:{ id:'dual', name:'双短刃', feel:'五连疾斩 · 走砍不停步' },
    desc:'双短刃\n五连疾斩 点燃敌人', unlock:{ txt:'累计击杀 120 解锁', ok:s=>s.totalKills>=120, prog:s=>[Math.min(s.totalKills,120),120] }, stat:'HP 5 · 速度 ●●●●',
    slash:[{dur:.11,range:102,half:1.15,dmg:1,kb:340,hs:.035},{dur:.11,range:106,half:1.2,dmg:1,kb:360,hs:.035},{dur:.11,range:110,half:1.2,dmg:1,kb:380,hs:.04},{dur:.11,range:114,half:1.25,dmg:1,kb:400,hs:.04},{dur:.2,range:132,half:Math.PI,dmg:2,kb:560,hs:.07}] },
